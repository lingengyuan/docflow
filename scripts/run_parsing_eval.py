...
from src.quality.parsing_eval import DEFAULT_CORPUS_DIR, DEFAULT_EXPECTED_PATH, run_parsing_eval
...
def main() -> int:
    ...
    parser.add_argument("--corpus", default=str(DEFAULT_CORPUS_DIR), help="Parsing corpus directory")
    parser.add_argument("--expected", default=str(DEFAULT_EXPECTED_PATH), help="Expected checks JSON")
    parser.add_argument("--write-results", action="store_true", help="Write output under eval/results")
