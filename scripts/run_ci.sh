...
"$PYTHON_BIN" main.py dev eval large-library --documents 200 --queries 5 \
  --max-index-ms-per-document 100 --max-lookup-p95-ms 500 \
  --max-retrieval-p95-ms 1500 --max-answer-p95-ms 2000 \
