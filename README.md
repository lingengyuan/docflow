...
- **Measured checks.** Current local checks include a 547-case public-domain regression eval, 84 source-filtered internal retrieval cases, 120 parsing fixtures, 445 tests, and 81 browser checks.
