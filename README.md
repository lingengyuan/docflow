...
- **Measured checks.** Current local checks include a 190-case public-domain smoke eval, 84 source-filtered internal retrieval cases, 31 parsing fixtures, 381 tests, and 81 browser checks.
