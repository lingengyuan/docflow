...
- **Measured checks.** Current local checks include a 547-case public-domain regression eval, 84 source-filtered internal retrieval cases, 120 parsing fixtures, 450 tests, 81 browser checks, and a release-surface check.
...
- Review source snippets, save useful answers as notes, and inspect topics, similar files, knowledge cards, active concepts, and source-to-answer trails.
