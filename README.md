...
- **Measured checks.** Current local checks include a 6-case public-domain smoke eval, 84 source-filtered internal retrieval cases, 31 parsing fixtures, 364 tests, and 79 browser checks.
