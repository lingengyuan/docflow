...
- **Measured checks.** Current local checks include a 190-case public-domain smoke eval, 84 source-filtered internal retrieval cases, 56 parsing fixtures, 390 tests, and 81 browser checks.
